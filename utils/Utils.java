...
public class Utils {
	...
	public static String readProp(String key){
		...
		try {
			...
			InputStream input = new FileInputStream(System.getProperty("user.dir") + "\\src\\il\\co\\alljob\\data\\config.properties");
	...
	public static WebDriver getDriver(){
		...
		case "FireFox": //	GeckoDriver = 0.19.0 | FireFox = 58.0.1 | selenium = 3.8.0
			...
			System.setProperty("webdriver.gecko.driver", readProp("C:\\automation\\drivers\\") + "geckodriver.exe");
			driver =  new FirefoxDriver();
			break;
		case "Chrome":
			System.setProperty("webdriver.chrome.driver", readProp("C:\\automation\\drivers\\") + "chromedriver.exe");
			driver = new ChromeDriver();
			break;
		case "IE":
			System.setProperty("webdriver.ie.driver", readProp("C:\\automation\\drivers\\") + "MicrosoftWebDriver.exe");
